 ...
 * It may compute this result by itself, or by {@linkplain Scope#restart(Restart.Option) delegating the work} to a
 * restart of its choice.
 * <p>
 * A handler doesn't <em>need</em> to handle a condition; it can decline to do so by returning
