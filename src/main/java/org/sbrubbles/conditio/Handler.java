 ...
 * compute this result by itself, or delegate the work to a restart, previously set up.
 * <p>
 ...
 * analyze a given condition, returning the end result (with {@link #apply(Object)}). Since it works both
 ...
 * @see Scope
 */
public interface Handler extends Predicate<Condition>, Function<Condition, Object> {
  /**
